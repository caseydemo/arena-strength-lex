...
export default function Footer() {
    ...
    return (
        ...
        <footer className={`bg-dark ${styles.footer_text_body}`}>
            <div className='text-center'>
                ...
                >
                    <svg
                        ...
                        height={height}
                        fill='currentColor'
                        className={`bi bi-facebook ${styles.footer_icon}`}
                        viewBox='0 0 16 16'
                    >
                ...
                >
                    <svg
                        ...
                        height={height}
                        fill='currentColor'
                        className={`bi bi-instagram ${styles.footer_icon}`}
                        viewBox='0 0 16 16'
                    >
                ...
                >
                    <svg
                        ...
                        height={height}
                        fill='currentColor'
                        className={`bi bi-mailbox2-flag ${styles.footer_icon}`}
                        viewBox='0 0 16 16'
                    >
                ...
                >
                    <svg
                        ...
                        height={height}
                        fill='currentColor'
                        className={`bi bi-phone-vibrate ${styles.footer_icon}`}
                        viewBox='0 0 16 16'
                    >
                ...
                >
                    <svg
                        ...
                        height={height}
                        fill='currentColor'
                        className={`bi bi-globe2 ${styles.footer_icon}`}
                        viewBox='0 0 16 16'
                    >
