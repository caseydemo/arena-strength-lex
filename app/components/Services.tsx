...
export default function Services() {  
  ...
  const default_height = 500;
    ...
    // make a list of services that are of type ServiceData and contain and image of type ImageData
    ...
    <div className="services">
      ...
      {services.map((service, index) => (
        <Service
            ...
            id={service.id}
            text={service.text}
            image_src={service.image.src}
            image_width={service.image.width}
            image_height={service.image.height}
            image_alt={service.image.alt}
        />
      ))}
    </div>
  );
